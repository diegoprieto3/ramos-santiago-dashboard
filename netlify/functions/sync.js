exports.handler = async function(event, context) {
  ...
  const ASSISTANT_ID = '08257fc8-721f-4267-9cb1-f3c29a35c216';
  ...
  try {
    ...
    for (const c of calls) {
      ...
      // If Ramos Santiago's Vapi assistant has Structured Outputs configured, this reads
      // them directly instead of regex-guessing from the transcript. If not configured,
      // these will simply return null and fall through to the raw values below.
